...
static inline const char *cxl_mbox_cmd_rc2str(struct mmio_mbox_cmd *mbox_cmd)
{
	return cxl_mbox_cmd_rctable[mbox_cmd->return_code].desc;
}

static inline int cxl_mbox_cmd_rc2errno(struct mmio_mbox_cmd *mbox_cmd)
{
